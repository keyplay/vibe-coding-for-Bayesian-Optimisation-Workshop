...
这周参加了一个 Hackathon，题目是用贝叶斯优化去调一个模拟的 CHO 细胞生物反应器，目标是在 15000 块虚拟预算内把蛋白产量（titre）拉到最高。五个输入变量：温度、pH、三次补料浓度（F1、F2、F3），外加三个保真度等级——便宜的小反应器跑一次 10 块，贵的大反应器跑一次 2100 块。
